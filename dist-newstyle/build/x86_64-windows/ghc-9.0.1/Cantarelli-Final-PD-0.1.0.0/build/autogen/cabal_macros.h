...
/* package Cantarelli-Final-PD-0.1.0.0 */
#ifndef VERSION_Cantarelli_Final_PD
#define VERSION_Cantarelli_Final_PD "0.1.0.0"
#endif /* VERSION_Cantarelli_Final_PD */
#ifndef MIN_VERSION_Cantarelli_Final_PD
#define MIN_VERSION_Cantarelli_Final_PD(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Cantarelli_Final_PD */
...
#define CURRENT_PACKAGE_KEY "Cantarelli-Final-PD-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "Cantarelli-Final-PD-0.1.0.0-inplace"
